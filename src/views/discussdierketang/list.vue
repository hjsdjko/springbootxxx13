	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('discussdierketang','新增')">新增</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('discussdierketang','修改')">修改</el-button>
					<el-button type="danger" :disabled="selRows.length?false:true" @click="delClick(null)" v-if="btnAuth('discussdierketang','删除')">删除</el-button>
				</div>
			</div>
			<br>
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="center">
					<template #default="scope">
						<el-button v-if="btnAuth('discussdierketang','查看评论')" type="warning" @click="commentClick(scope.row.id)">查看评论</el-button>
...
<script setup>
	...
	//基础信息
	const tableName = 'discussdierketang'
	const formName = '第二课堂评论表'
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscussdierketang?refid=' + id)
	}
