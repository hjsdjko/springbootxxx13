	...
	<div>
		<div class="app-contain">
			...
			<el-table
				...
				<el-table-column label="提交作业" :resizable='true' :sortable='true' align="left" header-align="center">
					<template #default="scope">
				...
				<el-table-column label="审核" v-if="btnAuth('zuoyetijiao','审核')" :resizable='true' :sortable='true' align="left" header-align="center">
					<template #default="scope">
